...
class GrowlNotifier:
    ...
    def _send_growl(self, options,message=None):
        ...
        if options['icon']:
            notice.add_header('Notification-Icon', 'https://github.com/kadeo/Sick-Beard/raw/master/data/images/sickbeard_touch_icon.png')
    ...
    def _sendRegistration(self, host=None, password=None, name='Sick Beard Notification'):
        ...
        register.add_header('Application-Icon', 'https://github.com/kadeo/Sick-Beard/raw/master/data/images/sickbeard_touch_icon.png')
