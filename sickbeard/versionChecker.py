...
class WindowsUpdateManager(UpdateManager):
    ...
    def __init__(self):
        ...
        self.version_url = 'https://raw.github.com/kadeo/Sick-Beard/windows_binaries/updates.txt'
...
class GitUpdateManager(UpdateManager):
    ...
    def _check_github_for_update(self):
        ...
        # find newest commit
        for curCommit in gh.commits.forBranch('kadeo', 'Sick-Beard', version.SICKBEARD_VERSION):
    ...
    def set_newest_text(self):
        ...
        if self._newest_commit_hash:
            url = 'http://github.com/kadeo/Sick-Beard/compare/'+self._cur_commit_hash+'...'+self._newest_commit_hash
        else:
            url = 'http://github.com/kadeo/Sick-Beard/commits/'
...
class SourceUpdateManager(GitUpdateManager):
    ...
    def update(self):
        ...
        tar_download_url = 'http://github.com/kadeo/Sick-Beard/tarball/'+version.SICKBEARD_VERSION
        sb_update_dir = os.path.join(sickbeard.PROG_DIR, 'sb-update')
